...
<!--   <button class="b2" form="accountform" type="submit" formaction="custaccount.php" formmethod="post" > -->
  <!-- <input class="cust" type="text"  name="u1" value=" -->
     ...
     <div style="background-image: linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.7)),url(Images/egg3.jpg); background-position: center; background-size: cover; height: 150vh; ">
      ...
      out.print("<tr align='center'><td  style='font-family: arial; color: #eee6e2; font-size:13pt;'>Gender :<td><input type='text' value='"+rs.getString(4)+"' readonly></tr>");
      out.print("<tr align='center'><td  style='font-family: arial; color: #eee6e2; font-size:13pt;'>Phone :<td><input type='text' value='"+rs.getLong(5)+"' readonly></tr>");
      out.print("<tr align='center'><td  style='font-family: arial; color: #eee6e2; font-size:13pt;'>Address :<td><input type='text' value='"+rs.getString(6)+"' readonly></tr>");
...
<!--help page--> 
    <section>
      <br>
      <center><font face="arial" color="#eee6e2" size="5">Help</font>
...
6. If you selected payment by mobile banking then ----------   <br>
 ...
 <td align="center" ><img src="Images/service.jpg" class="rcorner"  width="300"  height="250"> </td>
  ...
  <td><font face="arial" size="4" color="#292929">24x7 access </font></td>
     ...
     <tr> 
        <td colspan="2">
          <a href="custlogin.jsp"><font face="arial" size="7" color="#392f2b">
